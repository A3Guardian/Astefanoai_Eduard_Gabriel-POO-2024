...
using namespace std; //pentru biblioteca cu functii standard cunoscute de C++
//de citit notificatorii private, public, protected
struct Persoana {
    unsigned vs;
    char nume[20];
    char prenume[20];
...
public:
    ...
    char* arta_nume() { return this->nume; }
};
